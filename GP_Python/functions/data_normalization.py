...
def train_data_normalization(y_data):
    ...
    @param y_data: numpy_matrix: output data to be normed
    @return: numpy_matrix: normed output data
    """
